        ...
        <nav className='w-screen px-5 py-2 flex justify-between items-center'>
            ...
            <div className="flex justify-center items-center gap-3 pr-3">
                <NavLink to="/login" rel="noopener noreferrer">
                    <div className="text-sm font-medium text-black/60 hover:scale-105 cursor-pointer px-5 py-2 text-center hover:bg-blue-500 hover:text-white transition-all duration-300 ease-in-out rounded-sm">Login</div>
                </NavLink>
